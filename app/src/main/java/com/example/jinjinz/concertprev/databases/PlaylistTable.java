 ...
 */
public final class PlaylistTable extends MediaContract implements BaseColumns{
    ...
    private static final String CREATE_PLAYLIST_TABLE = "CREATE TABLE " + TABLE_NAME + "(" + _ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_SPOTIFY_ID + " TEXT NOT NULL, "
