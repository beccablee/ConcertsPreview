...
import com.jinjin.jinjinz.concertprev.databases.MediaContract.CurrentConcertTable;
import com.jinjin.jinjinz.concertprev.databases.MediaContract.CurrentSongTable;
import com.jinjin.jinjinz.concertprev.databases.MediaContract.PlaylistTable;
...
public class MediaPlayerService extends Service {
    ...
    public MediaPlayerService() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                while (isMyServiceRunning(MediaPlayerService.class) == null || isMyServiceRunning(MediaPlayerService.class) ) {
                    if (isMyServiceRunning(MediaPlayerService.class) == null) {
                        try {
                            Thread.sleep(100);
    ...
    private Boolean isMyServiceRunning(Class<?> serviceClass) {
        ...
        ActivityManager manager = (ActivityManager) getSystemService(Context.ACTIVITY_SERVICE); // bug
